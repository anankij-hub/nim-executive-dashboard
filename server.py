...
TRIP_ALIASES = {"เลขที่ใบรายการ": "เที่ยว", "น้ำหนักรวมที่บรรทุก": "น้ำหนักรวมที่บรรทุก(กิโลกรัม)", "ปริมาตรรวมที่บรรทุก": "ปริมาตรรวมที่บรรทุก(CBM)", "ทะเบียนรถ": "ทะเบียน", "สถานะข้อมูล2": "สถานะข้อมูล"}
